      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold">SAIF</h3>
                <p className="text-sm text-gray-300">SERVICE RESOURCES LIMITED</p>
              </div>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Leading provider of comprehensive industrial services and solutions across multiple sectors including textile, pharmaceutical, and agricultural technology.
            </p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 SAIF Service Resources Limited. All rights reserved.
          </p>
